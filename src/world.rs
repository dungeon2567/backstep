...
backstep_macros::system_group!(SimulationGroup { Before=[CleanupGroup] });
backstep_macros::system_group!(CleanupGroup { After=[SimulationGroup] });
backstep_macros::system_group!(DestroyGroup { After=[CleanupGroup] });
