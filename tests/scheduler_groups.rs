...
system!(SimSystem { query fn update(pos: &mut ViewMut<Position>, _vel: View<Velocity>) { pos.x += 1.0; } Parent=[backstep::world::SimulationGroup] });
system!(CleanupSystemLocal { query fn update(_pos: View<Position>) { let _ = _pos.x; } Parent=[backstep::world::CleanupGroup] });
