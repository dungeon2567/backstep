...
impl System for RPos {
    ...
    fn reads(&self) -> &'static [TypeId] {
        static R: &[TypeId] = &[TypeId::of::<backstep::world::World>()];
        R
    }
...
impl System for WPos {
    ...
    fn writes(&self) -> &'static [TypeId] {
        static W: &[TypeId] = &[TypeId::of::<backstep::world::World>()];
        W
    }
    fn as_any(&self) -> &dyn std::any::Any {
        self
...
impl System for Sim {
    ...
    fn parent(&self) -> Option<&dyn SystemGroup> {
        Some(backstep::world::SimulationGroup::instance())
    }
    fn as_any(&self) -> &dyn std::any::Any {
        self
    }
...
impl System for Clean {
    ...
    fn parent(&self) -> Option<&dyn SystemGroup> {
        Some(backstep::world::CleanupGroup::instance())
    }
    fn as_any(&self) -> &dyn std::any::Any {
        self
    }
...
impl System for Destroy {
    ...
    fn parent(&self) -> Option<&dyn SystemGroup> {
        Some(backstep::world::DestroyGroup::instance())
    }
    fn as_any(&self) -> &dyn std::any::Any {
        self
    }
